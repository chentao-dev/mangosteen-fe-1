...
export const emojiList: EmojiList = [
  ...
  ["person-resting", ["\u{1F9D8}", "\u{1F9D8}\u{200D}\u{2642}\u{FE0F}", "\u{1F9D8}\u{200D}\u{2640}\u{FE0F}", "\u{1F6C0}", "\u{1F6CC}"]],
  [
    "family",
    [
  ...
  ["animal-bird", ["\u{1F983}", "\u{1F414}", "\u{1F413}", "\u{1F423}", "\u{1F424}", "\u{1F425}", "\u{1F426}", "\u{1F427}", "\u{1F54A}", "\u{1F985}", "\u{1F986}", "\u{1F9A2}", "\u{1F989}", "\u{1F9A9}", "\u{1F99A}", "\u{1F99C}"]],
  ["animal-amphibian", ["\u{1F438}"]],
  ["animal-reptile", ["\u{1F40A}", "\u{1F422}", "\u{1F98E}", "\u{1F40D}", "\u{1F432}", "\u{1F409}", "\u{1F995}", "\u{1F996}"]],
  ["animal-marine", ["\u{1F433}", "\u{1F40B}", "\u{1F42C}", "\u{1F41F}", "\u{1F420}", "\u{1F421}", "\u{1F988}", "\u{1F419}", "\u{1F41A}"]],
  ["animal-bug", ["\u{1F40C}", "\u{1F98B}", "\u{1F41B}", "\u{1F41C}", "\u{1F41D}", "\u{1F41E}", "\u{1F997}", "\u{1F577}", "\u{1F578}", "\u{1F982}", "\u{1F99F}", "\u{1F9A0}"]],
  ["plant-flower", ["\u{1F490}", "\u{1F338}", "\u{1F4AE}", "\u{1F3F5}", "\u{1F339}", "\u{1F940}", "\u{1F33A}", "\u{1F33B}", "\u{1F33C}", "\u{1F337}"]],
  ["plant-other", ["\u{1F331}", "\u{1F332}", "\u{1F333}", "\u{1F334}", "\u{1F335}", "\u{1F33E}", "\u{1F33F}", "\u{2618}", "\u{1F340}", "\u{1F341}", "\u{1F342}", "\u{1F343}"]],
  ["food-fruit", ["\u{1F347}", "\u{1F348}", "\u{1F349}", "\u{1F34A}", "\u{1F34B}", "\u{1F34C}", "\u{1F34D}", "\u{1F96D}", "\u{1F34E}", "\u{1F34F}", "\u{1F350}", "\u{1F351}", "\u{1F352}", "\u{1F353}", "\u{1F95D}", "\u{1F345}", "\u{1F965}"]],
  ["food-vegetable", ["\u{1F951}", "\u{1F346}", "\u{1F954}", "\u{1F955}", "\u{1F33D}", "\u{1F336}", "\u{1F952}", "\u{1F96C}", "\u{1F966}", "\u{1F9C4}", "\u{1F9C5}", "\u{1F344}", "\u{1F95C}", "\u{1F330}"]],
  [
    "food-prepared",
    [
      "\u{1F35E}",
  ...
  ["food-asian", ["\u{1F371}", "\u{1F358}", "\u{1F359}", "\u{1F35A}", "\u{1F35B}", "\u{1F35C}", "\u{1F35D}", "\u{1F360}", "\u{1F362}", "\u{1F363}", "\u{1F364}", "\u{1F365}", "\u{1F96E}", "\u{1F361}", "\u{1F95F}", "\u{1F960}", "\u{1F961}"]],
  ["food-marine", ["\u{1F980}", "\u{1F99E}", "\u{1F990}", "\u{1F991}", "\u{1F9AA}"]],
  ["food-sweet", ["\u{1F366}", "\u{1F367}", "\u{1F368}", "\u{1F369}", "\u{1F36A}", "\u{1F382}", "\u{1F370}", "\u{1F9C1}", "\u{1F967}", "\u{1F36B}", "\u{1F36C}", "\u{1F36D}", "\u{1F36E}", "\u{1F36F}"]],
  ["drink", ["\u{1F37C}", "\u{1F95B}", "\u{2615}", "\u{1F375}", "\u{1F376}", "\u{1F37E}", "\u{1F377}", "\u{1F378}", "\u{1F379}", "\u{1F37A}", "\u{1F37B}", "\u{1F942}", "\u{1F943}", "\u{1F964}", "\u{1F9CB}", "\u{1F9C3}", "\u{1F9C9}", "\u{1F9CA}"]],
  ...
  ["place-geographic", ["\u{1F3D4}", "\u{26F0}", "\u{1F30B}", "\u{1F5FB}", "\u{1F3D5}", "\u{1F3D6}", "\u{1F3DC}", "\u{1F3DD}", "\u{1F3DE}"]],
  ["place-building", ["\u{1F3DF}", "\u{1F3DB}", "\u{1F3D7}", "\u{1F9F1}", "\u{1FAA8}", "\u{1F3D8}", "\u{1F3DA}", "\u{1F3E0}", "\u{1F3E1}", "\u{1F3E2}", "\u{1F3E3}", "\u{1F3E4}", "\u{1F3E5}", "\u{1F3E6}", "\u{1F3E8}", "\u{1F3E9}", "\u{1F3EA}", "\u{1F3EB}", "\u{1F3EC}", "\u{1F3ED}", "\u{1F3EF}", "\u{1F3F0}", "\u{1F492}", "\u{1F5FC}", "\u{1F5FD}"]],
  ["place-religious", ["\u{26EA}", "\u{1F54C}", "\u{1F6D5}", "\u{1F54D}", "\u{26E9}", "\u{1F54B}"]],
  ["place-other", ["\u{26F2}", "\u{26FA}", "\u{1F301}", "\u{1F303}", "\u{1F3D9}", "\u{1F304}", "\u{1F305}", "\u{1F306}", "\u{1F307}", "\u{1F309}", "\u{2668}", "\u{1F3A0}", "\u{1F3A1}", "\u{1F3A2}", "\u{1F488}", "\u{1F3AA}"]],
  [
    "transport-ground",
    [
      "\u{1F682}",
  ...
  ["transport-water", ["\u{2693}", "\u{26F5}", "\u{1F6F6}", "\u{1F6A4}", "\u{1F6F3}", "\u{26F4}", "\u{1F6E5}", "\u{1F6A2}"]],
  ["transport-air", ["\u{2708}", "\u{1F6E9}", "\u{1F6EB}", "\u{1F6EC}", "\u{1FA82}", "\u{1F4BA}", "\u{1F681}", "\u{1F69F}", "\u{1F6A0}", "\u{1F6A1}", "\u{1F6F0}", "\u{1F680}", "\u{1F6F8}"]],
  ...
  ["event", ["\u{1F383}", "\u{1F384}", "\u{1F386}", "\u{1F387}", "\u{1F9E8}", "\u{2728}", "\u{1F388}", "\u{1F389}", "\u{1F38A}", "\u{1F38B}", "\u{1F38D}", "\u{1F38E}", "\u{1F38F}", "\u{1F390}", "\u{1F391}", "\u{1F9E7}", "\u{1F380}", "\u{1F381}", "\u{1F397}", "\u{1F39F}", "\u{1F3AB}"]],
  ["award-medal", ["\u{1F396}", "\u{1F3C6}", "\u{1F3C5}", "\u{1F947}", "\u{1F948}", "\u{1F949}"]],
  ["sport", ["\u{26BD}", "\u{26BE}", "\u{1F94E}", "\u{1F3C0}", "\u{1F3D0}", "\u{1F3C8}", "\u{1F3C9}", "\u{1F3BE}", "\u{1F94F}", "\u{1F3B3}", "\u{1F3CF}", "\u{1F3D1}", "\u{1F3D2}", "\u{1F94D}", "\u{1F3D3}", "\u{1F3F8}", "\u{1F94A}", "\u{1F94B}", "\u{1F945}", "\u{26F3}", "\u{26F8}", "\u{1F3A3}", "\u{1F93F}", "\u{1F3BD}", "\u{1F3BF}", "\u{1F6F7}", "\u{1F94C}"]],
  ["game", ["\u{1F3AF}", "\u{1FA80}", "\u{1FA81}", "\u{1F3B1}", "\u{1F52E}", "\u{1F9FF}", "\u{1F3AE}", "\u{1F579}", "\u{1F3B0}", "\u{1F3B2}", "\u{1F9E9}", "\u{1F9F8}", "\u{2660}", "\u{2665}", "\u{2666}", "\u{2663}", "\u{265F}", "\u{1F0CF}", "\u{1F004}", "\u{1F3B4}"]],
  ...
  ["sound", ["\u{1F507}", "\u{1F508}", "\u{1F509}", "\u{1F50A}", "\u{1F4E2}", "\u{1F4E3}", "\u{1F4EF}", "\u{1F514}", "\u{1F515}"]],
  ["music", ["\u{1F3BC}", "\u{1F3B5}", "\u{1F3B6}", "\u{1F399}", "\u{1F39A}", "\u{1F39B}", "\u{1F3A4}", "\u{1F3A7}", "\u{1F4FB}"]],
  ["musical-instrument", ["\u{1F3B7}", "\u{1F3B8}", "\u{1F3B9}", "\u{1F3BA}", "\u{1F3BB}", "\u{1FA95}", "\u{1F941}"]],
  ["phone", ["\u{1F4F1}", "\u{1F4F2}", "\u{260E}", "\u{1F4DE}", "\u{1F4DF}", "\u{1F4E0}"]],
  ["computer", ["\u{1F50B}", "\u{1F50C}", "\u{1F4BB}", "\u{1F5A5}", "\u{1F5A8}", "\u{2328}", "\u{1F5B1}", "\u{1F5B2}", "\u{1F4BD}", "\u{1F4BE}", "\u{1F4BF}", "\u{1F4C0}", "\u{1F9EE}"]],
  ["light & video", ["\u{1F3A5}", "\u{1F39E}", "\u{1F4FD}", "\u{1F3AC}", "\u{1F4FA}", "\u{1F4F7}", "\u{1F4F8}", "\u{1F4F9}", "\u{1F4FC}", "\u{1F50D}", "\u{1F50E}", "\u{1F56F}", "\u{1F4A1}", "\u{1F526}", "\u{1F3EE}", "\u{1FA94}"]],
  ["book-paper", ["\u{1F4D4}", "\u{1F4D5}", "\u{1F4D6}", "\u{1F4D7}", "\u{1F4D8}", "\u{1F4D9}", "\u{1F4DA}", "\u{1F4D3}", "\u{1F4D2}", "\u{1F4C3}", "\u{1F4DC}", "\u{1F4C4}", "\u{1F4F0}", "\u{1F5DE}", "\u{1F4D1}", "\u{1F516}", "\u{1F3F7}"]],
  ["money", ["\u{1F4B0}", "\u{1F4B4}", "\u{1F4B5}", "\u{1F4B6}", "\u{1F4B7}", "\u{1F4B8}", "\u{1F4B3}", "\u{1F9FE}", "\u{1F4B9}"]],
  ["mail", ["\u{2709}", "\u{1F4E7}", "\u{1F4E8}", "\u{1F4E9}", "\u{1F4E4}", "\u{1F4E5}", "\u{1F4E6}", "\u{1F4EB}", "\u{1F4EA}", "\u{1F4EC}", "\u{1F4ED}", "\u{1F4EE}", "\u{1F5F3}"]],
  ["writing", ["\u{270F}", "\u{2712}", "\u{1F58B}", "\u{1F58A}", "\u{1F58C}", "\u{1F58D}", "\u{1F4DD}"]],
  ["office", ["\u{1F4BC}", "\u{1F4C1}", "\u{1F4C2}", "\u{1F5C2}", "\u{1F4C5}", "\u{1F4C6}", "\u{1F5D2}", "\u{1F5D3}", "\u{1F4C7}", "\u{1F4C8}", "\u{1F4C9}", "\u{1F4CA}", "\u{1F4CB}", "\u{1F4CC}", "\u{1F4CD}", "\u{1F4CE}", "\u{1F587}", "\u{1F4CF}", "\u{1F4D0}", "\u{2702}", "\u{1F5C3}", "\u{1F5C4}", "\u{1F5D1}"]],
  ["lock", ["\u{1F512}", "\u{1F513}", "\u{1F50F}", "\u{1F510}", "\u{1F511}", "\u{1F5DD}"]],
  ["tool", ["\u{1F528}", "\u{1FA93}", "\u{26CF}", "\u{2692}", "\u{1F6E0}", "\u{1F5E1}", "\u{2694}", "\u{1F52B}", "\u{1F3F9}", "\u{1F6E1}", "\u{1F527}", "\u{1F529}", "\u{2699}", "\u{1F5DC}", "\u{2696}", "\u{1F9AF}", "\u{1F517}", "\u{26D3}", "\u{1F9F0}", "\u{1F9F2}"]],
  ["science", ["\u{2697}", "\u{1F9EA}", "\u{1F9EB}", "\u{1F9EC}", "\u{1F52C}", "\u{1F52D}", "\u{1F4E1}"]],
  ["medical", ["\u{1F489}", "\u{1FA78}", "\u{1F48A}", "\u{1FA79}", "\u{1FA7A}"]],
  ["household", ["\u{1F6AA}", "\u{1F6D7}", "\u{1FA9F}", "\u{1F6CF}", "\u{1F6CB}", "\u{1FA91}", "\u{1F6BD}", "\u{1F6BF}", "\u{1F6C1}", "\u{1FA92}", "\u{1F9F4}", "\u{1F9F7}", "\u{1F9F9}", "\u{1F9FA}", "\u{1F9FB}", "\u{1F9FC}", "\u{1F9FD}", "\u{1F9EF}", "\u{1F6D2}"]],
  ["other-object", ["\u{1F6AC}", "\u{26B0}", "\u{26B1}", "\u{1F5FF}"]],
  ["transport-sign", ["\u{1F3E7}", "\u{1F6AE}", "\u{1F6B0}", "\u{267F}", "\u{1F6B9}", "\u{1F6BA}", "\u{1F6BB}", "\u{1F6BC}", "\u{1F6BE}", "\u{1F6C2}", "\u{1F6C3}", "\u{1F6C4}", "\u{1F6C5}"]],
  ["warning", ["\u{26A0}", "\u{1F6B8}", "\u{26D4}", "\u{1F6AB}", "\u{1F6B3}", "\u{1F6AD}", "\u{1F6AF}", "\u{1F6B1}", "\u{1F6B7}", "\u{1F4F5}", "\u{1F51E}", "\u{2622}", "\u{2623}"]],
  ["arrow", ["\u{2B06}", "\u{2197}", "\u{27A1}", "\u{2198}", "\u{2B07}", "\u{2199}", "\u{2B05}", "\u{2196}", "\u{2195}", "\u{2194}", "\u{21A9}", "\u{21AA}", "\u{2934}", "\u{2935}", "\u{1F503}", "\u{1F504}", "\u{1F519}", "\u{1F51A}", "\u{1F51B}", "\u{1F51C}", "\u{1F51D}"]],
  ["religion", ["\u{1F6D0}", "\u{269B}", "\u{1F549}", "\u{2721}", "\u{2638}", "\u{262F}", "\u{271D}", "\u{2626}", "\u{262A}", "\u{262E}", "\u{1F54E}", "\u{1F52F}"]],
  ["zodiac", ["\u{2648}", "\u{2649}", "\u{264A}", "\u{264B}", "\u{264C}", "\u{264D}", "\u{264E}", "\u{264F}", "\u{2650}", "\u{2651}", "\u{2652}", "\u{2653}", "\u{26CE}"]],
  ["av-symbol", ["\u{1F500}", "\u{1F501}", "\u{1F502}", "\u{25B6}", "\u{23E9}", "\u{23ED}", "\u{23EF}", "\u{25C0}", "\u{23EA}", "\u{23EE}", "\u{1F53C}", "\u{23EB}", "\u{1F53D}", "\u{23EC}", "\u{23F8}", "\u{23F9}", "\u{23FA}", "\u{23CF}", "\u{1F3A6}", "\u{1F505}", "\u{1F506}", "\u{1F4F6}", "\u{1F4F3}", "\u{1F4F4}"]],
  ...
  ["other-symbol", ["\u{2695}", "\u{267B}", "\u{269C}", "\u{1F531}", "\u{1F4DB}", "\u{1F530}", "\u{2B55}", "\u{2705}", "\u{2611}", "\u{2714}", "\u{274C}", "\u{274E}", "\u{27B0}", "\u{27BF}", "\u{303D}", "\u{2733}", "\u{2734}", "\u{2747}", "\u{00A9}", "\u{00AE}", "\u{2122}"]],
  ["keycap", ["\u{0023}\u{FE0F}\u{20E3}", "\u{002A}\u{FE0F}\u{20E3}", "\u{0030}\u{FE0F}\u{20E3}", "\u{0031}\u{FE0F}\u{20E3}", "\u{0032}\u{FE0F}\u{20E3}", "\u{0033}\u{FE0F}\u{20E3}", "\u{0034}\u{FE0F}\u{20E3}", "\u{0035}\u{FE0F}\u{20E3}", "\u{0036}\u{FE0F}\u{20E3}", "\u{0037}\u{FE0F}\u{20E3}", "\u{0038}\u{FE0F}\u{20E3}", "\u{0039}\u{FE0F}\u{20E3}", "\u{1F51F}"]],
  [
    "alphanum",
    [
      "\u{1F520}",
  ...
  ["flag", ["\u{1F3C1}", "\u{1F6A9}", "\u{1F38C}", "\u{1F3F4}", "\u{1F3F3}", "\u{1F3F3}\u{FE0F}\u{200D}\u{1F308}", "\u{1F3F4}\u{200D}\u{2620}\u{FE0F}"]],
  [
    "country-flag",
    [
      "\u{1F1E6} \u{1F1E8}",
  ...
  ["subdivision-flag", ["\u{1F3F4} \u{E0067} \u{E0062} \u{E0065} \u{E006E} \u{E0067} \u{E007F}", "\u{1F3F4} \u{E0067} \u{E0062} \u{E0073} \u{E0063} \u{E0074} \u{E007F}", "\u{1F3F4} \u{E0067} \u{E0062} \u{E0077} \u{E006C} \u{E0073} \u{E007F}"]],
];
